...
class TappBarr extends StatefulWidget {
  const TappBarr({super.key});

  @override
  State<TappBarr> createState() => _TappBarrState();
}
...
class _TappBarrState extends State<TappBarr> {
  bool x = false;
  @override
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(children: [
          Text('this is the groups screen'),
          ListView.builder(
